# surrealdb.rs
**
The official repo at https://github.com/surrealdb/surrealdb.rs was archived and removed but version 1.0.0-beta.9 has not been released yet so I made a copy of the repo to keep using it until said version is released
**
...
```bash
cargo add surrealdb-rs --git https://github.com/cdiezmoran/surrealdb-driver
```
